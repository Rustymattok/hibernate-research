...
import models.DriverManyToManyAnnotation;
...
public class DaoManyToManyAnnotationTest {
    ...
    public void add() {
        ...
        */
        ...
        EngineAnnotation engine = session.get(EngineAnnotation.class,4);
    ...
    public void update() {
        ...
        */
        ...
        CarManyToManyAnnotation car = session.get(CarManyToManyAnnotation.class,1);
         /*
